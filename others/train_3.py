...
from models_3 import Encoder, Decoder
...
model_name = 'model_3'  # model1:CNN, LSTM
...
checkpoint = None #'BEST_checkpoint_model2_coco_5_cap_per_img_5_min_word_freq.pth.tar'
# 'checkpoint_model1_loadPre_coco_5_cap_per_img_5_min_word_freq.pth.tar'
