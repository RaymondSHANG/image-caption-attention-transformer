...
from models_5 import Encoder, DecoderWithTransformer
...
model_name = 'model_5'  # model1:CNN, Transformer_full
...
# 'BEST_checkpoint_model5_coco_5_cap_per_img_5_min_word_freq.pth.tar'
# 'BEST_checkpoint_model_trans5_coco_5_cap_per_img_5_min_word_freq.pth.tar'
checkpoint = None #'BEST_checkpoint_model_trans5_coco_5_cap_per_img_5_min_word_freq.pth.tar'
        ...
        if False:  # epoch == 10:
            ...
            if False:  # best_epoch != 9:
                ...
                checkpoint = torch.load(
                    checkpoint_folder+"/"+'BEST_checkpoint_model_trans5_coco_5_cap_per_img_5_min_word_freq.pth.tar')
                start_epoch = checkpoint['epoch'] + 1
                epochs_since_improvement = checkpoint['epochs_since_improvement']
                best_bleu4 = checkpoint['bleu-4']
                decoder = checkpoint['decoder']
