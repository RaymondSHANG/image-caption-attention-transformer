...
from models_1 import Encoder, DecoderWithAttention
...
model_name = 'model_1'  # model1:CNN+attension, LSTM+attension
...
checkpoint = None #'checkpoint_model1_loadPre_coco_5_cap_per_img_5_min_word_freq.pth.tar'
