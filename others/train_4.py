...
from models_4 import Encoder, DecoderWithTransformer
...
model_name = 'model_4'  # model1:CNN, Transformer_simple
...
checkpoint = None  # "BEST_checkpoint_model3_coco_5_cap_per_img_5_min_word_freq.pth.tar"
...
def main():
    ...
    if checkpoint is None:
        #    def __init__(self, embed_dim, decoder_dim, vocab_size, encoder_imgwidth=ENCODED_IMG_SIZE, encoder_dim=2048, dropout=0.5, dim_k=96, dim_v=96, dim_q=96):

        decoder = DecoderWithTransformer(embed_dim=emb_dim,
